...
import com.github.dockerjava.core.command.StatsNoStreamCmdImpl;
...
public class DockerClientImpl implements Closeable, DockerClient {
    ...
    @Override
    public StatsNoStreamCmd statsNoStreamCmd(String containerId) {
        return new StatsNoStreamCmdImpl(getDockerCmdExecFactory().createStatsNoStreamCmdExec(), containerId);
    }
    ...
    @Override
    public InspectSwarmNodeCmd inspectSwarmNodeCmd(String nodeId) {
        return new InspectSwarmNodeCmdImpl(getDockerCmdExecFactory().inspectSwarmNodeCmdExec(), nodeId);
    }

    @Override
    public RemoveSwarmNodeCmd removeSwarmNodeCmd(String nodeId) {
        return new RemoveSwarmNodeCmdImpl(getDockerCmdExecFactory().removeSwarmNodeCmdExec(), nodeId);
    }
